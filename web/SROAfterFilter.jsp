    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-10 col-sm-offset-2 col-md-10 col-md-offset-1 main">
          <div class="row">
            <div class="col-md-10"><h2 class="category_shadow">SRO-AfterFilter</h2></div>
          </div>
          <hr/>
            ...
            <table id="table" class="table table-hover" sortLag="-1">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td data-toggle="modal" data-target=".bs-example-modal-sm"><span class="glyphicon glyphicon-pencil getGrantId" id="<%=request.getAttribute("grantId")%>"></span></td>
                      <td><%=++i%></td>
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <form class="form-signin" role="form" action="addDeadlineBySRO.action" method="post">
                                    ...
                                    <input type="submit" value="Add RSO Deadline" class="form-control"/>
                                </form>
                            </div>
                        </div>
                    </div>
